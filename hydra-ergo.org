...
*** org-brain
	...
	;; would rather keep using one file as to not miss other files
	;; one option is to :
	;; add advice to org-id-locations-save or load that goes through org-id-locations-file
	;; and replaces paths to wrong brain with default one.
	;; see func below for open and replace    

;; (defun foo ()
;;   (find-file "/home/olle/Dokument/org/foobar.org")
;;   (goto-line 0)
...
;;   (save-buffer))
	...
	(org-brain-switch-brain (car hydra-ergo-chosen-brain))
