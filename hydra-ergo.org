...
(defun save-theme-to-fav (group)
  (let ((curr-theme (car custom-enabled-themes)))
    (add-to-list (intern group) curr-theme)
    (when (find-file "~/.emacs.d/hydra-ergo/fav-themes.org")
      (hydra-ergo-add-var-orgfile group (symbol-name curr-theme)))))
     ...
     (defhydra hydra-ergo-cap-t-menu (:color red)
       ...
       ("d" (progn
	      (save-theme-to-fav "fav-dark-themes")
	      (print "Theme added to fav-dark-themes")) "add to fav-dark")
       ("l" (progn
	      (save-theme-to-fav "fav-light-themes")
...
*** org-database-helpers
    #+BEGIN_SRC emacs-lisp :results silent
(load "~/.emacs.d/hydra-ergo/hydra-ergo-org-db-helpers.el")
()
